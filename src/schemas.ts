...
export const VideoOutputSchema = z.object({
  ...
  source: z.string(),
  upload: z.record(z.unknown()).nullable(),
...
const ResultSchema = z.object({
  ...
  term_confidences: z.record(z.number()),
...
export const AnalysisOutputSchema = z.object({
  ...
  query: z.record(z.unknown()).describe(
  ...
  narrative: z.record(z.unknown()).nullable(),
  artifacts: z.record(z.unknown()).nullable(),
  error: ErrorObjectSchema.nullable(),
